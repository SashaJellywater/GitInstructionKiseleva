...
## Lifehack
---
При ошибках Гит обычно старается помочь пользователю и подсказать ему верную команду, например:

Для того, чтобы отобразить справочной информации о Git и часто используемых командах можно воспользоваться командой:
git-help -   
Автодополнение - авто дополнение для имен
файлов / каталогов работаетпо клавише Tab
Используйте автодополнение, так как оно позволяет сократить время на набор команды.

Сочетание клавиш Ctrl + L — очищает экран. Аналог команды clear.

Перемещаться между использованными командами можно стрелками 