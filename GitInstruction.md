...
## 9. Создание веток
---
Ииииииимя основной ветки Git-проекта по умолчанию **master** (однако зачастую бывает **main**, например, в GitHub), она появляется сразу при инициализации репозитория.<br>
